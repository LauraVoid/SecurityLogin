...
public class Main {
	 ...
	 * @param isAdmin
	 * @note el archivo de credenciales se encuentra estructurado así:
	...
	/**
	 * Metodo que permite eliminar la contraseña de un usuario, ingresando como administrador.
	 * 
	 * @param username el nombre del usuario al que le desea eliminar la constraseña.
	 */
	...
	/**
	 * Método que muestra el menú del usuario, y realiza todas sus funciones tanto
	 * la de consultar su último acceso en la BD y cambiar su contraseña
	 * 
	 * @param username
